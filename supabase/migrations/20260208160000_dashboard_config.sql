-- Configurable dashboards per role (Phase 2)
-- role, dashboard_slug, enabled, widget_order (display_order)
...
-- Seed: all role×dashboard combinations; enable only default dashboard per role
