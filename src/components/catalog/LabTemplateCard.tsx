    ...
    <>
      <Card 
        ...
        className={cn(
          ...
          isSelected && !hideSelection && "ring-2 ring-destructive bg-destructive/10"
        )}
        ...
        <div className="absolute top-3 right-3 z-10 flex items-center gap-1">
          ...
          <button 
            className={cn(
              ...
              "bg-background/80 backdrop-blur-sm shadow-sm hover:bg-background"
            )}
          ...
          <div className="flex items-start gap-3">
            <div className={cn(
              ...
              isFeatured && featuredColor
                ? featuredColor + " text-primary-foreground"
