...
export const AIAssistant = ({ context }: AIAssistantProps) => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm your AI assistant for MakeMyLabs. I can help you with:\n\n- Understanding lab requests and workflows\n- Navigating the Solutions → Delivery process\n- Filling out request forms\n- Questions about cloud types and billing\n\nHow can I help you today?",
    },
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const content = data?.content || "I'm sorry, I couldn't process that. Please try again.";
