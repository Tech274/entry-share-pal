    ...
    <div className="flex flex-col gap-3 p-4 bg-card border-b">
      ...
      <div className="flex flex-wrap items-center gap-4">
        <DateRangeFilter
          ...
          onFromChange={(v) => onUpdateFilter('startDateFrom', v)}
          onToChange={(v) => onUpdateFilter('startDateTo', v)}
        />
        <DateRangeFilter
          label="End Date"
          fromValue={filters.endDateFrom}
          toValue={filters.endDateTo}
          onFromChange={(v) => onUpdateFilter('endDateFrom', v)}
          onToChange={(v) => onUpdateFilter('endDateTo', v)}
        />
      </div>
    </div>
  );
